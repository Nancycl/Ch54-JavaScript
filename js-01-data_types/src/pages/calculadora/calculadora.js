...
*/
const edad = document.getElementById('birthdate').ariaValueMax;
const meses = 12;
function edad () {
    document.getElementById("result").textcontent = ('Tu edad en meses es de: ${edad * meses} meses.');
}

document.getElementById("calculate").onclick = calcular;